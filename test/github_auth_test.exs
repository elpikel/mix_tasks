defmodule MixTasksManager.GithubAuthTest do
  ...
  @github_response %Ueberauth.Auth{credentials: %Ueberauth.Auth.Credentials{expires: false,
   ...
   extra: %Ueberauth.Auth.Extra{raw_info: %{token: %OAuth2.AccessToken{access_token: "48da4aa418abc0cc02ea8dd40579e70192571f38",
       expires_at: nil, other_params: %{"scope" => "public_repo,user"},
       refresh_token: nil, token_type: "Bearer"},
      user: %{"collaborators" => 0, "two_factor_authentication" => true,
        "company" => nil, "bio" => nil, "following" => 1,
        "followers_url" => "https://api.github.com/users/test/followers",
        "public_gists" => 1, "id" => 29837,
        ...
        "emails" => [%{"email" => "test@gmail.com", "primary" => true,
           "verified" => true, "visibility" => "public"}], "private_gists" => 1,
        "blog" => "",
        ...
        "plan" => %{"collaborators" => 0, "name" => "free", "private_repos" => 0,
          "space" => 976562499}, "followers" => 4,
        "updated_at" => "2017-03-31T07:53:19Z", "total_private_repos" => 0}}},
   info: %Ueberauth.Auth.Info{description: nil, email: "test@gmail.com",
    first_name: nil, image: nil, last_name: nil, location: nil,
    name: "Test Test", nickname: "test", phone: nil,
    urls: %{api_url: "https://api.github.com/users/test",
      ...
      starred_url: "https://api.github.com/users/test/starred{/owner}{/repo}",
      subscriptions_url: "https://api.github.com/users/test/subscriptions"}},
   provider: :github, strategy: Ueberauth.Strategy.Github, uid: "test_id"}
